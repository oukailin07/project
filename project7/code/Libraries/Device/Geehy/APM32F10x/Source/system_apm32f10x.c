 ...
 * @attention
 *
 *  Copyright (C) 2020-2026 Geehy Semiconductor
 *
...
#define SYSTEM_CLOCK_96MHz  (96000000)  /* APM32F103 主频 96MHz */
...
#endif /* APM32F105xB || APM32F105xC || APM32F107xB || APM32F107xC */
...
#if defined(APM32F105xB) || defined(APM32F105xC) || defined(APM32F107xB) || defined(APM32F107xC)
        /* PLL2 configuration: PLL2CLK = (HSE / 5) * 8 = 40 MHz (HSE is 25MHz for APM32F105xB, APM32F105xC, APM32F107xB, APM32F107xC) */
...
#if defined(APM32F105xB) || defined(APM32F105xC) || defined(APM32F107xB) || defined(APM32F107xC)
        /* PLL2 configuration: PLL2CLK = (HSE / 5) * 12 = 60 MHz (HSE is 25MHz for APM32F105xB, APM32F105xC, APM32F107xB, APM32F107xC) */
...
#endif /* SYSTEM_CLOCK_HSE || SYSTEM_CLOCK_24MHz || SYSTEM_CLOCK_36MHz || SYSTEM_CLOCK_48MHz || SYSTEM_CLOCK_56MHz || SYSTEM_CLOCK_72MHz || SYSTEM_CLOCK_96MHz */

...
/* Build config: uncomment for real HW with MAX31865, comment for Proteus simulation */
//#define USE_MAX31865
...
/* ADC channels: PA0=Vib, PA1=Temp(ADC mode), PA2/PA3/PA4=3-phase current */
...
#ifdef USE_MAX31865
    g_sensor.temperature = MAX31865_Get_Temperature();
#else
